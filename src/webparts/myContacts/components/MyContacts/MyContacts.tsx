...
import { IMyContactsProps, IMyContactsState } from '.';
...
export class MyContacts extends React.Component<IMyContactsProps, IMyContactsState> {

  constructor(props: IMyContactsProps) {
    super(props);
  ...
  public componentDidUpdate(prevProps: IMyContactsProps, prevState: IMyContactsState): void {
  ...
  public render(): React.ReactElement<IMyContactsProps> {
    return (
