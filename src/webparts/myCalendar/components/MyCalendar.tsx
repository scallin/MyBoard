...
import { IMyCalendarProps, IMyCalendarState, IMeeting, IMeetings } from '.';
...
export default class MyCalendar extends React.Component<IMyCalendarProps, IMyCalendarState> {
  ...
  private _reRender = (): void => {
    // update the render date to force reloading data and re-rendering the component
    this.setState({ renderedDateTime: new Date() });
  }

  /**
   * Sets interval so that the data in the component is refreshed on the specified cycle
   */
