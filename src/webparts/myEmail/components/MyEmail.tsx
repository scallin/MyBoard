...
import { IMyEmailProps, IMyEmailState, IMessage, IMessages } from '.';
import { WebPartTitle } from '@pnp/spfx-controls-react/lib/WebPartTitle';
import { Spinner, SpinnerSize } from 'office-ui-fabric-react/lib/components/Spinner';
import { List } from 'office-ui-fabric-react/lib/components/List';
import { Link } from 'office-ui-fabric-react/lib/components/Link';

export class MyEmail extends React.Component<IMyEmailProps, IMyEmailState> {
  
  constructor(props: IMyEmailProps) {
    super(props);
  ...
  public componentDidUpdate(prevProps: IMyEmailProps, prevState: IMyEmailState): void {
